...
<head>
    <title>ORTHOSCOOT by OSMOSE : Demande de réservation</title>
                                                            ...
                                                            <tr>
                                                                <td class="w580"  width="580">
                                                                    ...
                                                                    <div align="left" class="article-content">
                                                                        <p> Bonjour {$nom},</p>
                                                                        <p>
                                                                            Nous avons bien reçu votre demande de réservation de<br />
                                                                            l'ORTHOSCOOT pour la date du <span style="color:#E22242;">{$debut}</span> avec une date de restitution prévue <span style="color:#E22242;">{$retour|strtolower}</span>.
                                                                        </p>
                                                                        <p>
                                                                            Afin de confirmer votre commande, merci <strong>d'imprimer</strong>
                                                                            le bon de<br />commande ci-joint et de nous le retourner <strong>signé</strong>
                                                                            accompagné de<br />vos règlements à l'adresse suivante :
                                                                        </p>
                                                                        <p>
                                                                        	OSMOSE SARL<br />
                                                                        	312 Avenue des Etats-Unis<br />
                                                                        	31200 TOULOUSE
                                                                        </p>
                                                                        <p style="color:#000">
